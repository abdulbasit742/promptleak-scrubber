...
These instructions apply to the entire `abdulbasit742/promptleak-scrubber` repository. More specific AGENTS.md or AGENTS.override.md files in subdirectories may refine them.

Project: **PromptLeak Scrubber**.
